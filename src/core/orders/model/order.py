...
from sqlalchemy import (
    Boolean, Column, DateTime, Enum as SQLEnum, ForeignKey, String,
...
class Order(Base):
    ...
    def __repr__(self):
        return f"<Order(order_id={self.order_id}, order_number={self.order_number}, customer_id={self.customer_id}, total_amount={self.total_amount})>"
