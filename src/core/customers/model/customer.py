...
class Customer(Base):
    """
    Customer model for storing saved payment recipients.
    Users can save customers and send money to them quickly.
    """
    ...
    def __repr__(self):
        return f"<Customer(id={self.id}, user_id={self.user_id}, name={self.name}, network={self.network})>"
